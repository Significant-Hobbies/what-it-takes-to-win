...
|---|---|---|
| Automated comprehension contract | PASS | 8 semantic surfaces passed in `npm run audit:clarity`. |
...
## Five-question external comprehension protocol
...
Pass when every participant answers at least four of five correctly, at least 80%
