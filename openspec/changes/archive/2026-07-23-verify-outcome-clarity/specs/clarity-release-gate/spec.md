...
The project SHALL provide a local check that verifies the required model, tier, overlap, non-prediction, person-path, and actionable-comparison concepts remain present.

#### Scenario: Essential explanation disappears
- **WHEN** a required concept or stable surface identifier is removed
